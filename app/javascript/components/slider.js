...
sliders.forEach((slider) => {
  ...
  if (name == "playlist[popularity]") {
    slider.style.background = 'linear-gradient(to right, rgba(9,142,237,1) 0%, rgba(10,207,213,1) ' + valeur + '%, #fff ' + valeur + '%, white 100%)';
    slider.oninput = function() {
    this.style.background = 'linear-gradient(to right, rgba(9,142,237,1) 0%, rgba(10,207,213,1) ' + this.value + '%, #fff ' + this.value + '%, white 100%)'
    };
  }
  else {
